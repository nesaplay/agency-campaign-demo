              ...
              {viewMode === 'grid' ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                  {publishers.map(publisher => (
                    <div key={publisher.id} className="relative group">
                      <PublisherCard 
                        publisher={publisher}
                        onClick={() => {}}
                      />
                ...
                <div className="space-y-4">
                  {publishers.map(publisher => (
                    <div key={publisher.id} className="relative group">
                      ...
                      />
                      <button 
                        className="absolute top-4 right-4 bg-white text-red-500 p-1.5 rounded-full shadow-md opacity-0 group-hover:opacity-100 transition-opacity"
                        onClick={() => handleRemovePublisher(publisher.id)}
                      >
                        <Trash2 className="h-4 w-4" />
                      </button>
