...
import { ListFilter, Grid3X3, Calendar } from "lucide-react";
...
const NavigatorTabs = forwardRef<HTMLDivElement, NavigatorTabsProps>(
  (
    ...
    const [activeTab, setActiveTab] = React.useState<"publishers" | "collections" | "seasonal">("publishers");

    return (
      <div
        ref={ref}
        className={`flex-1 h-full bg-white border-b border-gray-200 ${
