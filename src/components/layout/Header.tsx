      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="text-right hidden sm:block">
            ...
            <p className="text-xs text-gray-500">Media Buyer</p>
          </div>
          <div className={cn(
            "h-9 w-9 rounded-full flex items-center justify-center text-white font-medium text-sm",
            "bg-gradient-to-r from-empowerlocal-green to-empowerlocal-blue"
          )}>
            JC
          </div>
        </div>
